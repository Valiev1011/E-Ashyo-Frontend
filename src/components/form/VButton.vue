<template>
  <button
    :class="classess"
    :disabled="isLoading"
    class="flex justify-center items-center border-none transition-all ease-in-out duration-100 disabled:cursor-not-allowed text-white !py-[14px] !rounded-[12px] !text-[14px] !font-[600]"
  >
    <slot></slot>
    <div v-if="isLoading">
      <svg
...
const type_style = {
  primary:
    "bg-[#134E9B] hover:bg-[#5388a8] active:bg-[#416D89] disabled:bg-[#416D89]",
